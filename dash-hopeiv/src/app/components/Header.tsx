...
export default function Header() {
  ...
  return (
    <header className="bg-black white py-4 shadow-md sticky top-0 z-10">
      <div className="container mx-auto px-4 flex justify-between items-center">
        ...
        <nav className="hidden md:block">
          <ul className="flex space-x-6 items-center">
            <li>
              <Link href="/reports" className="text-gray-100 hover:text-gray-400">
                Reports
              </Link>
            </li>
            <li>
            ...
            <li>
              <button onClick={logout} className="bg-red-600 hover:bg-red-700 text-gray-100 font-medium py-2 px-4 rounded-lg text-sm">
                Logout
              </button>
            </li>
          </ul>
